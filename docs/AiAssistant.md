...
* `AiAssistantPanel` slides in from the right and occupies one quarter of the viewport when opened. It contains model selection, conversation history, and the prompt composer.
