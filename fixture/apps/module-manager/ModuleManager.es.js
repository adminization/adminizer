...
var n = v();
const f = window.React.useState, U = window.UIComponents.Button, $ = window.UIComponents.Table, I = window.UIComponents.TableBody, l = window.UIComponents.TableCell, i = window.UIComponents.TableHead, g = window.UIComponents.TableHeader, b = window.UIComponents.TableRow, y = window.UIComponents.Card, E = window.UIComponents.CardContent, k = window.UIComponents.CardHeader, M = window.UIComponents.CardTitle, d = window.sonner.toast, T = window.axios, m = window.InertiajsReact.router, _ = window.JSComponents.DeleteModal;
function H({ data: c }) {
  const [u, o] = f(c.modules), x = async (e, r) => {
    const s = r === "enabled" ? "disable" : "enable";
    try {
      await T.post(`${window.routePrefix}/module-manager/${s}`, { name: e }), d.success(`Модуль ${e} успешно ${s === "enable" ? "включён" : "выключен"}.`), o(
        (h) => h.map(
    ...
    try {
      await T.post(`${window.routePrefix}/module-manager/unregister`, { name: e }), d.success(`Модуль ${e} успешно удалён.`), o((r) => r.filter((s) => s.name !== e)), m.reload();
    } catch {
      d.error(`Ошибка при удалении модуля ${e}.`);
    }
  };
  return /* @__PURE__ */ n.jsx(n.Fragment, { children: /* @__PURE__ */ n.jsxs(y, { className: "py-4", children: [
    /* @__PURE__ */ n.jsx(k, { children: /* @__PURE__ */ n.jsx(M, { children: "Менеджер модулей" }) }),
    /* @__PURE__ */ n.jsx(E, { children: /* @__PURE__ */ n.jsxs($, { children: [
      /* @__PURE__ */ n.jsx(g, { children: /* @__PURE__ */ n.jsxs(b, { children: [
      ...
      /* @__PURE__ */ n.jsx(I, { children: u.map((e) => /* @__PURE__ */ n.jsxs(b, { children: [
