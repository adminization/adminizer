...
var e = R();
const u = window.React.useState, I = window.UIComponents.Button, T = window.UIComponents.Select, k = window.UIComponents.SelectContent, j = window.UIComponents.SelectItem, N = window.UIComponents.SelectTrigger, U = window.UIComponents.SelectValue, b = window.axios, E = window.UIComponents.Textarea, p = window.UIComponents.Label, L = window.UIComponents.Checkbox, f = window.sonner.toast, _ = window.LucideReact;
function A({ data: d }) {
  const [l, a] = u(""), [i, t] = u(""), [n, r] = u(!1), [o, v] = u(!1), S = async (s) => {
    ...
    try {
      ...
      console.log(C.data), f.success("Сообщение успешно отправлено!");
    } catch (m) {
  ...
  return /* @__PURE__ */ e.jsx(e.Fragment, { children: /* @__PURE__ */ e.jsx("div", { className: "grid gap-4", children: /* @__PURE__ */ e.jsxs("form", { onSubmit: S, className: "flex flex-col gap-4 max-w-[400px]", children: [
    ...
    /* @__PURE__ */ e.jsxs("div", { children: [
      ...
      /* @__PURE__ */ e.jsxs(
        T,
        {
          ...
          disabled: o,
          children: [
            /* @__PURE__ */ e.jsx(N, { id: "user-select", className: "w-full", children: /* @__PURE__ */ e.jsx(U, { placeholder: "-- Выберите --" }) }),
    ...
    /* @__PURE__ */ e.jsxs("div", { className: "flex gap-2 items-center", children: [
      ...
      n && /* @__PURE__ */ e.jsx(_.Loader2, { className: "w-6 h-6 animate-spin" })
    ] })
  ] }) }) });
}
export {
