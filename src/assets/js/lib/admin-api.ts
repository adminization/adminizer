...
const requestJson = async <TResponse>(
    ...
    try {
        const response = await request<TResponse>(method, url, data, options);
...
export const adminApi = {
    ...
    getJson: <TResponse>(url: string, options?: HttpRequestOptions) =>
        requestJson<TResponse>('get', url, undefined, options),
    postJson: <TResponse>(url: string, data?: unknown, options?: HttpRequestOptions) =>
        requestJson<TResponse>('post', url, data, options),
    putJson: <TResponse>(url: string, data?: unknown, options?: HttpRequestOptions) =>
        requestJson<TResponse>('put', url, data, options),
    patchJson: <TResponse>(url: string, data?: unknown, options?: HttpRequestOptions) =>
        requestJson<TResponse>('patch', url, data, options),
    deleteJson: <TResponse>(url: string, data?: unknown, options?: HttpRequestOptions) =>
        requestJson<TResponse>('delete', url, data, options),
};
