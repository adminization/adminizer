 ...
 */
export abstract class AbstractFilterCustomFieldHandler {
...
/**
 * FilterCustomFieldHandler - registry for custom field handlers
 */
export class FilterCustomFieldHandler {
    private handlers: Map<string, AbstractFilterCustomFieldHandler> = new Map();

    private validateInputConfig(handler: AbstractFilterCustomFieldHandler): void {
     ...
     */
    public add(
        handler: AbstractFilterCustomFieldHandler,
     ...
     * Get handler by ID
     */
    public get(id: string): AbstractFilterCustomFieldHandler | undefined {
     ...
     * Get all handlers
     */
    public getAll(): Map<string, AbstractFilterCustomFieldHandler> {
     ...
     */
    public getForModel(modelName: string): Map<string, AbstractFilterCustomFieldHandler> {
        const modelHandlers = new Map<string, AbstractFilterCustomFieldHandler>();
...
export default FilterCustomFieldHandler;
